...
const ProductCard = ({ title, description, originalPrice, discountedPrice, discount }) => {
    const formatPrice = (price) => {
        return new Intl.NumberFormat().format(price);
    };
    return (
        <div className="flex flex-col w-52 shadow-md rounded-lg">
            <div className="w-full aspect-square p-1">
                <div className="bg-black/10 rounded-lg w-full h-full"></div>
            </div>
            <div className="p-2">
                <h3 dir="rtl" className="text-lg">{title}</h3>
                ...
                <div className="flex justify-between mt-2">
                    <div className="flex gap-1 items-center opacity-80">
                        ...
                        <svg className="w-4 h-4" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080">
